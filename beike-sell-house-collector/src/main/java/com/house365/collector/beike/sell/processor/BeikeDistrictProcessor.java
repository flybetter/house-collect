 ...
 * 贝壳区属板块Processor
 */
public class BeikeDistrictProcessor extends AbstractDistrictProcessor {

    private Set<String> districtUrlSet = new HashSet<>();
    private Site site = Site.me().setRetryTimes(3).setSleepTime(1000).setTimeOut(10000);

    public BeikeDistrictProcessor(String cityCode, String cityRootUrl) {
    ...
    public void process(Page page) {
        ...
        List<Selectable> districtTags = page.getHtml().xpath("/html/body/div[1]/div[3]/div[1]/dl[2]/dd/div[1]/div[1]/a")
                .nodes();
        ...
        List<String> districtNames = page.getHtml().xpath
                ("/html/body/div[1]/div[3]/div[1]/dl[2]/dd/div[1]/div[1]/a").css(".selected", "text").all();
        ...
        List<Selectable> subDistrictTags = page.getHtml().xpath
                ("/html/body/div[1]/div[3]/div[1]/dl[2]/dd/div[1]/div[2]/a").nodes();
        if (subDistrictTags.size() != 0) {
            ...
            for (Selectable subDistrictTag : subDistrictTags) {
                ...
                DistrictVO objSubDistrict = new DistrictVO(cityCode, PlatformEnum.BEIKE.getId(), district,
