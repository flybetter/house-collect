package com.house365.collector.wuba.sell.personal.downloader;
 ...
 * 58 Downloader
 */
public class WubaDownloader extends AbstractDownloader {

    private final Map<String, CloseableHttpClient> httpClients = new HashMap<String, CloseableHttpClient>();
    private Logger logger = LoggerFactory.getLogger(WubaDownloader.class);
    ...
    public WubaDownloader(boolean directDownloadFirst) {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            if (page.toString().contains("访问过于频繁，本次访问做以下验证码校验")) {
                // 被58检测到爬虫,下载失败
                return Page.fail();
            }
